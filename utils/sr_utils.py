# form https://github.com/DmitryUlyanov/deep-image-prior/blob/master/utils/sr_utils.py
# Changes: enforcing image dimension in load_LR_HR_imgs_sr to a multiple of 64 
...
def load_LR_HR_imgs_sr(fname, imsize, factor, enforse_div32=None):
    ...
    print('orig size {}'.format(img_orig_pil.size))
